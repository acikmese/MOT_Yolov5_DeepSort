...
2. Make sure that you fulfill all the requirements: Python 3.6 or later with all [requirements.txt](https://github.com/acikmese/MOT_Yolov5_DeepSort/blob/master/requirements.txt) dependencies installed, including torch>=1.7. To install, run:
